<div class="dashboard-shell">
    <aside class="dashboard-sidebar">
        ...
        <nav class="dashboard-menu" aria-label="Menu dashboard">
            <a class="active" href="<?php echo e(app_url('dashboard')); ?>"><span>&#8962;</span>Dashboard</a>
    ...
    <main class="dashboard-main">
        ...
        <section class="dashboard-search-row" aria-label="Pencarian lapangan">
            <label class="dashboard-search">
                <span>&#128269;</span>
                <input type="search" placeholder="Cari lapangan, lokasi, atau jenis olahraga...">
            </label>
            <button type="button" class="dashboard-filter"><span>&#9776;</span>Filter</button>
        </section>

        <section class="dashboard-stats" aria-label="Ringkasan booking">
